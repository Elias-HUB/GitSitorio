...
namespace Practica_7
{
    public partial class Menu : Form
    {
        ...
        private void BtnNegrita(object sender, EventArgs e)
        {
        ...
        private void BtnSubrayado(object sender, EventArgs e)
        {
            Font viejaFuente; //Declaro una variable Class Font para la Fuente Vieja.
            Font nuevaFuente; //Declaro una variable Class Font para la Fuente Nueva.
                              //Asigno a viejaFuente el tipo de fuente seleccionado.
        ...
        private void BtnCursiva(object sender, EventArgs e)
        {
            Font viejaFuente; //Declaro una variable Class Font para la Fuente Vieja.
            Font nuevaFuente; //Declaro una variable Class Font para la Fuente Nueva.
                              //Asigno a viejaFuente el tipo de fuente seleccionado.
        ...
        private void BtnCentrar(object sender, EventArgs e)
        {
        ...
        private void KeyPressTamanio(object sender, KeyPressEventArgs e)
        {
            ...
            else if (e.KeyChar == 13)
            {
                ...
                if (TextBFuente.Text.Length > 0)
                    //Llamo al método Aplicar Tamaño al Texto.
                    AplicarTamanioText(TextBFuente.Text);
        ...
        private void Validador(object sender, EventArgs e)
        {
        ...
        private void LC(object sender, LinkClickedEventArgs e)
        {
